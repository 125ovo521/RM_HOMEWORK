...
bool interfaces__msg__ore_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._ore_info.OreInfo", full_classname_dest, 32) == 0);
  }
  interfaces__msg__OreInfo * ros_message = _ros_message;
  {  // num
...
{
  /* NOTE(esteve): Call constructor of OreInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._ore_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OreInfo");
